...
# ==========================================================================
# три поломки, найденные пробой обычного питона
# ==========================================================================
...
def test_a_text_field_is_true_when_it_is_not_empty(boards):
    ...
    SQLite в `CASE WHEN 'Дом'` приводит текст к числу и говорит «нет»: без
    оговорки формула всегда уходит во вторую ветку -- ни ошибки, ни следа,
    неверно только число на экране.
    """
