...
чужого формата в SQL нет и не будет. Раньше ответом был отказ; теперь такой
код можно объявить **устройственным** -- он поедет исходником и выполнится
настоящим питоном прямо у пользователя.
