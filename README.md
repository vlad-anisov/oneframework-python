...
Спящих нет. Всё, чему нужно ядро, — план, посев, развёрнутые выражения — живёт
в монорепозитории, в полосе «вместе»: проверка, которая не может пройти там,
куда её положили, не сторож.
